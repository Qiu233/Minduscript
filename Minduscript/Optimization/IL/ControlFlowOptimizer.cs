...
{
	public class ControlFlowOptimizer : ILBaseOptimizer
	{
		...
		public ControlFlowOptimizer(ILOptimizerContext ctx) : base(ctx)
		{
		...
		{
			Log("Running control flow optimization...");
